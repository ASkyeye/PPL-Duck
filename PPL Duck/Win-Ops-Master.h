...
public:
	...
	/// <returns></returns>
	HANDLE CreateObjDir(std::wstring dir, HANDLE hshadow = NULL);
	/// <summary>
	/// Create a non persistent native directory in object manager
	/// </summary>
	/// <param name="dir">Path to the dir to be created</param>
	/// <returns></returns>
	HANDLE CreateObjDir(std::string dir, HANDLE hshadow = NULL);
	/// <summary>
	/// Open HANDLE to object manager directory with MAXIMUM_ALLOWED access
	/// </summary>
	/// <param name="dir">Path to the dir to be opened</param>
	/// <returns></returns>
	HANDLE OpenObjDir(std::wstring dir, DWORD access = MAXIMUM_ALLOWED);
	/// <summary>
	/// Open HANDLE to object manager directory with MAXIMUM_ALLOWED access
	/// </summary>
	/// <param name="dir">Path to the dir to be opened</param>
	/// <returns></returns>
	HANDLE OpenObjDir(std::string dir, DWORD access = MAXIMUM_ALLOWED);
	/// <summary>
	...
	bool CreateNTFSLink(HANDLE hfile, std::wstring target, std::wstring printname = L"", bool relative = false);

	bool SetProcessDeviceMap(HANDLE hprocess, HANDLE hdevice_map);
